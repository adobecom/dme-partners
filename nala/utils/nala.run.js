...
\x1b[1m2] Options:\x1b[0m
  ...
  \x1b[33m* project=<project-name>\x1b[0m             Project configuration (default: dme-partners-live-chromium)
...
function getLocalTestLiveUrl(env, milolibs) {
  if (milolibs) {
    if (env === 'local') {
      ...
      return `https://${env}--da-dme-partners--adobecom.aem.live/?milolibs=${milolibs}`;
    }
  } else {
    if (env === 'local') {
      ...
      return `https://${env}--da-dme-partners--adobecom.aem.live`;
    }
  }
}
